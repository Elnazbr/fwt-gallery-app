const Pagination = (props) => {
  const renderPages = () => {
    ...
    if (props.pageCount <= 3) {
      ...
      content.push(
        <a href=" " onClick={(e) => props.setPage(e, 1)} className="active">
          1
        </a>
      );
      content.push(
        <a href=" " onClick={(e) => props.setPage(e, 2)}>
          2
        </a>
      );
      content.push(
        <a href=" " onClick={(e) => props.setPage(e, 3)}>
          3
        </a>
      );
    } else if (props.page === props.pageCount) {
      content.push(
        <a href=" " onClick={(e) => props.setPage(e, props.pageCount - 2)}>
          {props.pageCount - 2}
        </a>
      );
      content.push(
        <a href=" " onClick={(e) => props.setPage(e, props.pageCount - 1)}>
          {props.pageCount - 1}
        </a>
      );
      content.push(
        <a
          href=" "
          onClick={(e) => props.setPage(e, props.pageCount)}
          className="active"
        >
          {props.pageCount}
        </a>
    ...
    <div className="pagination">
      ...
      >
        <svg
          ...
          height="13"
          viewBox="0 0 14 13"
          className={props.page === 1 ? "pagination-disabled" : ""}
      ...
      <a
        className={props.page === props.pageCount ? "disabled" : ""}
        href=" "
        onClick={props.nextPage}
      >
        <svg
          className={
            props.page === props.pageCount ? "pagination-disabled" : ""
          }
          width="9"
          height="13"
          viewBox="0 0 9 13"
